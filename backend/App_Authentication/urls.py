...
from .views import RegisterView, VerifyOTPView, ResendOTPView, LoginView, ForgotPasswordView, VerifyResetOTPView, ResetPasswordView, ResendForgotPasswordOTPView, ProfileView
